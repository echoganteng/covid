...
<head>
	...
	<link href="img/icokpu.ico" rel="icon">
...
<body>
			...
			<div class="content">
				<div class="container">	
					...
					<div class="btn-holder">
						<a href="javascript:void(0)" class="btn btn-custom btn-transparent" onclick="openAboutStyle()">Website Utama</a>
						...
						<a href="https://infopemilu.kpu.go.id" class="btn btn-custom btn-transparent" target="_BLANK">Cek Pemilih</a>
					...
					<div class="about-box">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="row">
									<div class="col-md-12">
										<a href="http://kab-situbondo.kpu.go.id" class="btn btn-custom btn-transparent" target="_BLANK">Website Utama klik disini</a>
									</div>
								</div>
							</div>
						</div>
	...
	<script src="js/jquery.countdown-id.js"></script>
	<!-- ajaxchimp Js -->
