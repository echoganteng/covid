...
*/
	...
	// austDay = new Date(austDay.getFullYear(), 10-9, 24, 9, 0);
	// $('#defaultCountdown').countdown({until: austDay});
	// $('#year').text(austDay.getFullYear());

	var austDay = new Date(); // result: "Date Tue Feb 04 2020 09:00:00 GMT+0700 (Western Indonesia Time)"
	austDay = new Date(austDay.getFullYear(), 12-4, 23, 7);
	$('#defaultCountdown').countdown({until: austDay});
	$('#year').text(austDay.getFullYear());
console.log(austDay);
/*
