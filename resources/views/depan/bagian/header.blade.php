                    ...
                    <div class="company-info clearfix">
                        <div class="company-info-item">
                            <div class="header-icon">
                                <img src="{{asset('/tema/frontend/images/icons/phone.png')}}" alt="">
                            </div>
                            <div class="header-info">
                                <h6>+0 123-456-7890</h6>
                                <p>We are open 9 am - 10pm</p>
                            </div>
                        </div>
                        <div class="company-info-item">
                            <div class="header-icon">
                                <img src="{{asset('/tema/frontend/images/icons/mail-open.png')}}" alt="">
                            </div>
                            <div class="header-info">
                                <h6><a href="mailto:info@domain.com">info@domain.com</a></h6>
                                <p>You can mail us</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="main-menu text-center">
                                <li><a href="index.html">Home</a>
                                    <ul class="drop-menu">
                                        ...
                                        <li><a href="index-12.html">Property Location Map</a></li>
                                        <li><a href="index-13.html">Background Video (Vimeo)</a></li>
                                    </ul>
                                </li>
