...
<div class="portlet light ">
    <div class="portlet-title">
        <div class="caption font-green">
            ...
            <span class="caption-subject bold uppercase"> Tambah Opini</span>
        </div>
        <div class="actions">
            <div class="btn-group">
    ...
    <div class="portlet-body form">
        <form role="form" method="POST" action="{{url('panel/opini')}}">
        {{ csrf_field() }}
            <div class="form-body">
                ...
                <div class="form-group last">
                    ...
                    <textarea id="siduy" name="opini">{!! old('opini') !!}</textarea>
                </div>
            </div>
