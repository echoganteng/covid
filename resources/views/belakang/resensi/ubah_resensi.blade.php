...
<div class="portlet light ">
    <div class="portlet-title">
        <div class="caption font-green">
            ...
            <span class="caption-subject bold uppercase"> Ubah Resensi</span>
        </div>
        <div class="actions">
            <div class="btn-group">
    ...
    <div class="portlet-body form">
        <form role="form" method="POST" action="{{url('panel/resensi/'.$resensi->id)}}">
        {{ csrf_field() }}{{ method_field('PUT') }}
            <div class="form-body">
                <div class="form-group form-md-line-input form-md-floating-label">
                    <input type="text" class="form-control" id="form_control_1" name="judul" value="{{$resensi->judul}}" >
                ...
                <div class="form-group form-md-line-input form-md-floating-label col-md-3">
                    <div class="row">
                        ...
                        @foreach($stats as $stat)
                            <option value="{{$stat->nama_status}}" {{ $stat->nama_status == $resensi->status ? 'selected="selected"' : '' }} >{{$stat->nama_status}}</option>
                        @endforeach
                        </select>
                ...
                <div class="form-group form-md-line-input form-md-floating-label col-md-3">
                        <div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd">
                            <input type="text" class="form-control" id="form_control_1" name="tgl_buat" value="{{$resensi->tgl_buat}}" readonly>
                ...
                <div class="form-group form-md-line-input form-md-floating-label col-md-6">
                    <div class="input-group">
                        <input id="thumbnail" class="form-control" type="text" name="filepath" value="{{$resensi->gambar}}">
                ...
                <div class="form-group last">
                    ...
                    <textarea id="siduy" name="resensi">{!! $resensi->isi_resensi !!}</textarea>
                </div>
            </div>
